      ...
      models: [
        {
          ...
          reasoning: false,
          input: ["text"],
          cost: { input: 1.73, output: 6.04, cacheRead: 0, cacheWrite: 0 },
        ...
        },
        {
          ...
          reasoning: false,
          input: ["text"],
          cost: { input: 0.86, output: 1.44, cacheRead: 0, cacheWrite: 0 },
          contextWindow: 131072,
          maxTokens: 8192,
        },
        {
          ...
          reasoning: false,
          input: ["text"],
          cost: { input: 2.01, output: 3.16, cacheRead: 0, cacheWrite: 0 },
          contextWindow: 131072,
          maxTokens: 8192,
        },
        {
          ...
          reasoning: false,
          input: ["text", "image"],
          cost: { input: 1.44, output: 4.60, cacheRead: 0, cacheWrite: 0 },
          contextWindow: 262144,
          maxTokens: 8192,
        },
        {
        ...
        },
        {
          ...
          reasoning: true,
          input: ["text", "image"],
          cost: { input: 0.52, output: 1.15, cacheRead: 0, cacheWrite: 0 },
          contextWindow: 262144,
          maxTokens: 8192,
        },
      ],
